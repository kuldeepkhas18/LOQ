...
def AuthenticateFace():
    ...
    recognizer.read('engine\\auth\\trainer.yml')  # load trained model
    ...
    names = ['', 'kuldeep']  # names, leave first empty bcz counter starts from 0
    ...
    while True:
        ...
        for(x, y, w, h) in faces:
            ...
            cv2.putText(img, str(display_accuracy), (x+5, y+h-5), 
                        font, 1, (255, 255, 0), 1)
